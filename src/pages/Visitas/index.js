...
const listRef = firebase.firestore().collection('visitas').orderBy('created','desc');
        ...
        return(
            <div>
                ...
                <div className="content">
                    <Title nome="Textos para Visitas Técnicas">
                        <AiFillCar size={25} />
                    </Title>
                </div>
                                ...
                                return(
                                    <tr key={index}>
                                        ...
                                        <td data-label="">
                                            ...
                                            <Link className="action" to={`/editvisitas/${item.id}`}
